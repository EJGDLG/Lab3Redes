...
class LinkState(BaseAlgorithm):
    ...
    def __init__(self, node_id: str):
        super().__init__(node_id); self.seq=0; self.lsdb={}; self.seen_lsp={}; self.costs={}; self.next_hop={}
    ...
    def _recompute(self):
        ...
        src=self.node_id; dist={v:float('inf') for v in graph}; prev={v:None for v in graph}; dist[src]=0.0; pq=[(0.0,src)]
        while pq:
